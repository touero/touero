...
# the user name you want to display
custom_name="weiensong"

setopt prompt_subst
PROMPT="${purple}${custom_name:-%n}%{$reset_color%} ${limegreen}%~%{$reset_color%}\$(virtualenv_prompt_info)\$(ruby_prompt_info)\$vcs_info_msg_0_${orange} $%{$reset_color%} "
